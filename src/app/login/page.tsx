  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md border border-line bg-white p-10 text-center">
          ...
          <p className="mt-2 text-sm text-muted">Sign in to manage leads, invoices, and tasks.</p>
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 flex w-full items-center justify-center gap-3 border border-line bg-white px-4 py-3 text-sm font-medium text-ink hover:border-brand-accent disabled:opacity-50"
          >
          ...
          <p className="mt-6 text-[11px] uppercase tracking-widest2 text-muted">
            New here? Sign in once and an admin will approve your access.
          </p>
        </div>
      </main>
